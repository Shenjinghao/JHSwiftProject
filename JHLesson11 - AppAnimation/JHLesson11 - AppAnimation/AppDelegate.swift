//
//  AppDelegate.swift
//  JHLesson11 - AppAnimation
//
//  Created by 作业帮 on 2018/3/24.
...
class AppDelegate: UIResponder, UIApplicationDelegate, CAAnimationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        self.mask = CALayer()
        self.mask!.contents = UIImage(named: "bg1")?.cgImage
    ...
    func appAnimate() {
        ...
        let secondBounds = NSValue.init(cgRect: CGRect(x: 0, y: 0, width: 90, height: 73))
        let finalBounds = NSValue.init(cgRect: CGRect(x: 0, y: 0, width: 1600, height: 1300))
